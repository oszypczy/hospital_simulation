...
RandomPatientGenerator::RandomPatientGenerator(){
    ...
    surnames = {"Nowak", "Kowalsk", "Wiśniewsk", "Dąbrowsk", "Lewandowsk", "Wójcik", "Kamińsk", "Kowalczyk", "Zielińsk", "Szymańsk", "Woźniak", "Kozłowsk", "Jankowsk", "Wojciechowsk", "Kwiatkowsk", "Kaczmarek", "Mazur", "Krawczyk", "Piotrowsk", "Grabowsk", "Nowakowsk", "Pawłowsk", "Michalsk", "Nowick", "Adamczyk", "Dudek", "Zając", "Wieczorek", "Jabłońsk", "Kró", "Majewsk", "Olszewsk", "Jaworsk", "Wróbel", "Malinowsk", "Pawla", "Witkowsk", "Walczak", "Stępnie", "Górsk", "Rutkowsk", "Michalak", "Sikora", "Ostrowsk", "Baran", "Dud", "Szewczyk", "Tomaszewsk", "Pietrzak", "Marciniak", "Wróblewsk", "Zalewsk", "Jakubowsk", "Jasińsk", "Zawadzk", "Sadowsk", "Bą", "Chmielewsk", "Włodarczyk", "Borkowsk", "Czarneck", "Sawick", "Sokołowsk", "Urbańsk", "Kubiak", "Maciejewsk", "Szczepańsk", "Kucharsk", "Wilk", "Kalinowsk", "L", "Mazurek", "Wysock", "Adamsk", "Kaźmierczak", "Wasilewsk", "Sobczak", "Czerwińsk", "Andrzejewsk", "Cieślak", "Głowack", "Zakrzewsk", "Kołodzie", "Sikorsk", "Krajewsk"};
};
