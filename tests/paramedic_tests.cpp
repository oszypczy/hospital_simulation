...
{
    Paramedic Lidka("03232407362", "Lidia", "Strzelecka", Sex::female, 20);
    ...
    CHECK(Lidka.getActivity() == ParamedicActivity::RESTING);
    ...
    SECTION("testing valid setters")
    {
        ...
        Lidka.setActivity(ParamedicActivity::IN_AMBULANCE);
        ...
        CHECK(Lidka.getActivity() == ParamedicActivity::IN_AMBULANCE);
    }
    ...
    SECTION("testing << operator")
    {
        std::stringstream ss;
        ss << Lidka;
        CHECK(ss.str() == "Paramedic: Lidia Strzelecka (03232407362).");
    }
}