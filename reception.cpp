...
void Reception::addPatientToQueueFirst(std::unique_ptr<Patient> patient){
    patientsQueue.push_front(generateService(std::move(patient)));
}

void Reception::addPatientToQueueLast(std::unique_ptr<Patient> patient){
    patientsQueue.push_back(generateService(std::move(patient)));
}
...
std::unique_ptr<Patient> Reception::generateService(std::unique_ptr<Patient> patient){
